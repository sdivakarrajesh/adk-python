...
class TestOAuth2CredentialExchanger:
  ...
  def test_exchange_with_existing_token(self):
    ...
    result = exchanger.exchange(credential, scheme)
  ...
  def test_exchange_missing_auth_scheme(self):
    ...
    exchanger = OAuth2CredentialExchanger()
    try:
      exchanger.exchange(credential, None)
      assert False, "Should have raised ValueError"
    except ValueError as e:
      assert "auth_scheme is required" in str(e)

  @patch("google.adk.auth.oauth2_session_helper.OAuth2Session")
  def test_exchange_no_session(self, mock_oauth2_session):
  ...
  @patch("google.adk.auth.oauth2_session_helper.OAuth2Session")
  def test_exchange_fetch_token_failure(self, mock_oauth2_session):
  ...
  def test_exchange_authlib_not_available(self):
