...
class TestOAuth2SessionHelper:
  """Test suite for OAuth2SessionHelper."""

  def test_init(self):
    """Test OAuth2SessionHelper initialization."""
    ...
    helper = OAuth2SessionHelper(scheme, credential)
    assert helper._auth_scheme == scheme
    assert helper._auth_credential == credential
  ...
  def test_update_credential_with_tokens(self):
    """Test update_credential_with_tokens method."""
    scheme = OpenIdConnectWithConfig(
        type_="openIdConnect",
        openId_connect_url=(
            "https://example.com/.well-known/openid_configuration"
